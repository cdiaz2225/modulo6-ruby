...
#Ejercicio 5
puts numeros.select {|n| n.to_s.start_with? "7" or n.to_s.end_with? "7"}
# resultado = numeros.select {|n| n.to_s.start_with? "7" or n.to_s.end_with? "7"}
# puts resultado
 
if File.exist?("/home/codm/modulo6/ejercicio3/resultado.txt")
    File.open("/home/codm/modulo6/ejercicio3/resultado.txt","a") do |file|
        file.write(resultado, "\n")
    end
else 
    File.open("/home/codm/modulo6/ejercicio3/resultado.txt","w") do |file|
        file.write(resultado, "\n")
    end
end
